...
public class BoardController {
	...
	public String myCalendar(String screen, Model model,HttpSession session) {
	...
	public String myRecord(Model model,HttpSession session,String search1, String search2, String page, String pageUnit,String cls2_cd,String screen ) {
	...
	public String myWriter(HttpSession session , Model model,String cls2_cd ,String search1, String search2,String screen) {
	...
	public String myEdit(HttpSession session , Model model,String cls2_cd) {
